...
- ✓TEST: GET requests to /api/peep should return all peeps in the database
...
1. **As a user, I want to be able to sign up to Chitter, so that I can post from my account**
...
2. **As a user, I want to be able log in to Chitter, so I can post a Peep**
...
3. **As a user, I want to be able to log out of Chitter, so that others can't access my account**

- ✓TEST: Should see Log In button after logging out

4. **As a user, I want to be able to see all peeps, regardless of whether I am logged in or not, so I can keep updated on what's happening**
...
5. **As a user, I want to see peeps displayed in reverse chronological order, so I can see the la- test Peeps first**
